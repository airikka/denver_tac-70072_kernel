...
#if defined (CONFIG_TOUCHSCREEN_GSL168X)
...
static struct ts_hw_data ts_hw_info_1680 = {
	.reset_gpio = TOUCH_RESET_PIN,
};
#endif
...
static struct rk30_adc_battery_platform_data rk30_adc_battery_platdata = {
        .dc_det_pin      = DC_DET_PIN,//INVALID_GPIO,     DC_DET_PIN,
        .batt_low_pin    = INVALID_GPIO,
        .charge_set_pin  = INVALID_GPIO,
        .charge_ok_pin   =INVALID_GPIO,//RK2928_PIN1_PA5,
        .dc_det_level    = GPIO_LOW,   //GPIO_LOW
...
static struct cpufreq_frequency_table dvfs_gpu_table[] = {
        {.frequency = 266 * 1000,	.index = 1200 * 1000},//1100
        {.frequency = 400 * 1000,	.index = 1275 * 1000},
        {.frequency = CPUFREQ_TABLE_END},
};

static struct cpufreq_frequency_table dvfs_ddr_table[] = {
//        {.frequency = 200 * 1000,	.index = 1200 * 1000},//1100
        {.frequency = 300 * 1000,	.index = 1200 * 1000},//1100
        {.frequency = 400 * 1000,	.index = 1200 * 1000},//1100
        {.frequency = CPUFREQ_TABLE_END},
};
