...
//#define CONFIG_SENSOR_0 RK29_CAM_SENSOR_GC2035                      /* back camera sensor 0 */
/*
#define CONFIG_SENSOR_IIC_ADDR_0 	  0x42 //0x78
...
#define CONFIG_SENSOR_0  RK29_CAM_SENSOR_GC0308         //RK29_CAM_SENSOR_GC0329                      /* back camera sensor 0 */

#define CONFIG_SENSOR_IIC_ADDR_0 	 0x42 //0x62 
#define CONFIG_SENSOR_IIC_ADAPTER_ID_0	  1
#define CONFIG_SENSOR_CIF_INDEX_0				  0
#define CONFIG_SENSOR_ORIENTATION_0      90
#define CONFIG_SENSOR_POWER_PIN_0         INVALID_GPIO
...
#define CONFIG_SENSOR_1  RK29_CAM_SENSOR_GC0329          // RK29_CAM_SENSOR_GC0308          /* front camera sensor 0 */

#define CONFIG_SENSOR_IIC_ADDR_1 	  0x62   // 0x42
#define CONFIG_SENSOR_IIC_ADAPTER_ID_1	  1
#define CONFIG_SENSOR_CIF_INDEX_1				  0
#define CONFIG_SENSOR_ORIENTATION_1       90 //270
...
//#define CONFIG_SENSOR_1 RK29_CAM_SENSOR_SP0A19                      /* front camera sensor 0 */
/*
...
//#define CONFIG_SENSOR_11 RK29_CAM_SENSOR_GC0329                      /* front camera sensor 1  good  RK29_CAM_SENSOR_GC0329    0x62   90*/
/*
...
//#define CAMERA_NAME	              "gc2035_back"
//#define CAMERA_NAME	              "gc0329_back"
#define CAMERA_NAME	              "gc0308_back"
#define CONFIG_SENSOR_POWERDNACTIVE_LEVEL_PMU  1  // 1->0 add by lin
...
static void rk_cif_power(int on)
{
    struct regulator *ldo_18,*ldo_28;
      ...
      #if defined(CONFIG_MACH_RK2926_V86)
	  printk("==rk_cif_power config_mach_rk2926_v86  !!!!!\n");
...
static int sensor_powerdown_usr_cb (struct rk29camera_gpio_res *res,int on)
{
    #if defined(CONFIG_MACH_RK2926_V86)
    int ret = 0; 
	 printk("%s.............sensor_powerdown_usr_cb----------------------\n",res->dev_name);
