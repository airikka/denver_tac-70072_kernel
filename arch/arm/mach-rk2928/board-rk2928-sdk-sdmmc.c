...
//
    ...
    #if defined(CONFIG_RK903) || defined(CONFIG_RK901) || defined(CONFIG_RTL8192CU) || defined(CONFIG_RTL8188EU)|| defined(CONFIG_MT7601)
    //power
    ...
    #if defined(CONFIG_RTL8192CU) || defined(CONFIG_RTL8188EU) || defined(CONFIG_MT7601)
        #define RK30SDK_WIFI_GPIO_POWER_N               RK30_PIN3_PD0            
        #define RK30SDK_WIFI_GPIO_POWER_ENABLE_VALUE    GPIO_HIGH        
    ...
    #elif defined(CONFIG_RTL8192CU) || defined(CONFIG_RTL8188EU) || defined(CONFIG_RT5370)|| defined(CONFIG_MT7601)
...
//        #define CONFIG_USB_WIFI_POWER_CONTROLED_BY_GPIO
        ...
        #define RK30SDK_WIFI_GPIO_POWER_ENABLE_VALUE   GPIO_HIGH //GPIO_LOW 
...
#if defined(CONFIG_RTL8192CU) || defined(CONFIG_RTL8188EU) || defined(CONFIG_RT5370)|| defined(CONFIG_MT7601)
