...
static int gsensor_report_value(struct i2c_client *client, struct sensor_axis *axis)
{
	...
	*/
/* Q8   
	input_report_abs(sensor->input_dev, ABS_X, -(axis->y));   //width
	input_report_abs(sensor->input_dev, ABS_Z, -(axis->x));    //height
...
/*  86V  		*/
	...
	/*  shuang mian board 		
	input_report_abs(sensor->input_dev, ABS_Z, (axis->y));   //width
	input_report_abs(sensor->input_dev, ABS_X, (axis->x));    //height
	input_report_abs(sensor->input_dev, ABS_Y, axis->z);
*/
