...
/*
	if (bl->props.brightness >0 && bl->props.brightness <255)
		brightness = bl->props.brightness/2+rk29_bl_info->min_brightness ;

	if (bl->props.brightness <0 )
		brightness = bl->props.brightness ;

	if (bl->props.brightness >255 )
		brightness = 255;
*/
